...
const int esc_out_pin = 11;
const int motor_pin = A1;


//These switches are active_low, aka, switch closed == low.
const int trigger_switch = A0;
const int cycle_switch = A2;
const int rev_switch = 12;
const int mag_switch = A4;
const int selector_switch_a = 10;
const int selector_switch_b = 9;
...
//http://www.electroschematics.com/9351/arduino-digital-voltmeter/
  const float R1 = 68200.0; // resistance of R1 (75K) -see text!
  const float R2 = 10020.0; // resistance of R2 (10K) - see text!
