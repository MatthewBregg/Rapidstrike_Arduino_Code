...
.equ	POWER_RANGE	= 1500 + MIN_DUTY ; 999 is maximum for still having startup drop
.endif
...
.equ	TIMING_MAX	= 0x00fd ; use that as governor setpoint (e0=25510rpm Hy-Con 9.5mm -- torukmakto4 04-28-18), 9a is 37k, 11d is 20K, 110 is 21K, 108 is 21.65K
